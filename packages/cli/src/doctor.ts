...
async function checkTicketpilotDirs(): Promise<CheckResult> {
  ...
  const missingDirs = missing.filter(Boolean) as string[];
...
async function checkJiraConnection(): Promise<CheckResult> {
